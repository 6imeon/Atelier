...
AI-native UI design platform with multi-model support via OpenRouter.

Redesign entire websites from a URL, generate production-ready UI screens from natural language, and edit everything on an infinite canvas with a built-in design system editor.
...
# Create the data volume (compose expects it as external)
...
For full research, gap analysis, and the phased improvement roadmap, see [automatching-algorithm.md](docs/automatching-algorithm.md).
...
See [entra-setup.md](docs/entra-setup.md) for the full setup guide.
...
See [export-import.md](docs/export-import.md) for the full design document.
...
See [docs/database.md](docs/database.md) for the full implementation checklist.
